...
def load_mp(inputfile):
    ...
    t_amps_dict = chkfile.load("data/{}".format(material["imds"]), "t_amps")
...
def load_eris(inputfile):
    ...
    eris = _ERIS(mycc)
    eris_dict = chkfile.load("data/{}".format(material["imds"]), "eris")
...
def load_imds(inputfile):
    ...
    imds_dict = chkfile.load("data/{}".format(material["imds"]), "imds")
